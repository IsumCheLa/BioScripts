...
1. python draw1.py (вычисляет размеры первой и второй хромосомы и рисует график)
2. python draw2.py (вычисляет размеры первой и второй хромосомы, делит количество генов на них и рисует график)
